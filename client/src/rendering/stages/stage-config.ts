...
export const STAGE_VISUALS: Record<StageId, StageVisualConfig> = {
  barnyard: {
    ...
    background: "/assets/stages/backgrounds/barnyard-brawl.png", focusX: 0.52,
  ...
  fridge: {
    ...
    background: "/assets/stages/backgrounds/fridge-frenzy.png", focusX: 0.5,
  ...
  meadow: {
    ...
    background: "/assets/stages/backgrounds/sky-high-meadow.png", focusX: 0.54,
