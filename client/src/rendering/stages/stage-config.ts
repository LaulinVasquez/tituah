...
import barnyardBackgroundUrl from "../../../public/assets/stages/backgrounds/barnyard-brawl.png";
import fridgeBackgroundUrl from "../../../public/assets/stages/backgrounds/fridge-frenzy.png";
import meadowBackgroundUrl from "../../../public/assets/stages/backgrounds/sky-high-meadow.png";
...
export const STAGE_VISUALS: Record<StageId, StageVisualConfig> = {
  barnyard: {
    ...
    background: resolveAssetUrl(barnyardBackgroundUrl), focusX: 0.52,
  ...
  fridge: {
    ...
    background: resolveAssetUrl(fridgeBackgroundUrl), focusX: 0.5,
  ...
  meadow: {
    ...
    background: resolveAssetUrl(meadowBackgroundUrl), focusX: 0.54,
